...
export const PostCard: React.FC<PostCardProps> = ({ post, user, onClick }) => {
  return (
    <div className="bg-white dark:bg-black border-b border-gray-200 dark:border-neutral-800 sm:border sm:rounded-lg mb-4 sm:mb-8 max-w-[470px] w-full mx-auto transition-all hover:shadow-sm">
      ...
      {/* Project CTA */}
      {/* <div className="border-t border-gray-100 dark:border-neutral-800 p-3 flex gap-2">
        <a 
            href={post.demoUrl || '#'} 
            className="flex-1 bg-gray-100 dark:bg-neutral-800 text-gray-900 dark:text-white text-sm font-semibold py-1.5 rounded text-center hover:bg-gray-200 dark:hover:bg-neutral-700 transition-colors active:scale-95 duration-150"
        >
            View Demo
        </a>
        <a 
            href={post.repoUrl || '#'}
            className="flex-1 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-sm font-semibold py-1.5 rounded text-center hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors active:scale-95 duration-150"
        >
            Source Code
        </a>
      </div> */}
