  ...
  return (
    <div className="relative max-w-[470px] mx-auto mb-6 group">
      ...
      {showLeft && (
        <button 
          onClick={() => scroll('left')}
          className="absolute -left-3 top-1/2 -translate-y-1/2 z-10 bg-white dark:bg-neutral-800 rounded-full p-1.5 shadow-md border border-gray-100 dark:border-neutral-700 text-gray-700 dark:text-gray-200 transition-all hover:scale-110"
        >
          <ChevronLeft size={20} />
        </button>
      )}
      ...
      {showRight && (
        <button 
          ...
          className="absolute -right-3 top-1/2 -translate-y-1/2 z-10 bg-white dark:bg-neutral-800 rounded-full p-1.5 shadow-md border border-gray-100 dark:border-neutral-700 text-gray-700 dark:text-gray-200 transition-all hover:scale-110"
        >
